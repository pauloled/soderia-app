        ...
        <div className="collapse navbar-collapse justify-content-end">
          <ul className="navbar-nav d-flex align-items-center gap-2">
            ...
            {rol === "admin" && (
              <>
                <li className="nav-item">
                  <button className="btn btn-outline-light" onClick={() => navigate("/productos")}>Productos</button>
                </li>
                <li className="nav-item">
                  <button className="btn btn-outline-light" onClick={() => navigate("/ventas")}>Ventas</button>
                </li>
                <li className="nav-item">
                  <button className="btn btn-outline-light" onClick={() => navigate("/usuarios")}>Clientes</button>
                </li>
              </>
            )}
            {usuario && (
